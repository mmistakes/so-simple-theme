...
## Stylized 3D
Growing library of styles with powerful [painterly materials](/software/MNPRX/docs/uber/) and [proxies](/software/MNPRX/docs/proxy/) that drive the stylization and its aesthetic effects within 3D space.
