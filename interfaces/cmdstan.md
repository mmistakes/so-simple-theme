...
* [CmdStan 2.15.0 [tar.gz]](https://github.com/stan-dev/cmdstan/releases/download/v2.15.0/cmdstan-2.15.0.tar.gz)
  <span class="note">(GitHub)</span>

* [CmdStan 2.15.0 [zip]](https://github.com/stan-dev/cmdstan/releases/download/v2.15.0/cmdstan-2.15.0.zip)
   <span class="note">(GitHub)</span>
...
* <p>
  <a href="https://github.com/stan-dev/cmdstan/releases/download/v2.15.0/cmdstan-guide-2.15.0.pdf"><i>CmdStan
    Interface User's Guide, v2.15.0</i></a>
  &nbsp; <span class="note">(GitHub)</span>
  </p>
