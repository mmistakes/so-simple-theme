...
This latter form of the model is coded in Stan as follows. Links to source: 

$\color{red}{\text{Option 1}}$ [R](regression/regression_1.R), [Python](regression/regression_1.py), [Stan](https://github.com/stan-dev/example-models/blob/footnotes/user-guide-models/linear_regression_1/linear_regression_1.stan) 

$\color{red}{\text{Option 2}}$ [regression_1.R](regression/regression_1.R), [regression_1.py](regression/regression_1.py), [regression_1.stan](https://github.com/stan-dev/example-models/blob/footnotes/user-guide-models/linear_regression_1/linear_regression_1.stan) 

$\color{red}{\text{Option 3}}$
[Regression_1](https://github.com/stan-dev/example-models/tree/footnotes/user-guide-models/linear_regression_1)
