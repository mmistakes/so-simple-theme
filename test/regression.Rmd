...
$$
This latter form of the model is coded in Stan as follows [regression_1](https://github.com/stan-dev/stan-dev.github.io/blob/master/test/regression_1/)
```{r echo=FALSE, comment=""}
library(knitr)
stan_text = read_file('regression_1/regression_1.stan')
...
```{r echo=FALSE, comment=""}
stan_text = read_file('regression_2/regression_2.stan')
writeLines(stan_text)
```
