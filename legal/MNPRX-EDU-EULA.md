...
Please read this End-User License Agreement ("Agreement") carefully before clicking the "I Agree" button, downloading or using MNPRX Education ("Application").
...
* use the Application outside of a registered educational institution.
